...
public class Attack extends Game {
    ...
    public Dice setDice(Dice newDice) {
                    ...
                    while (win == false) {
                        ...
                        while (TypeInCheck1 == true) {
                            if (Attacker.getTroopCount() >= 3) {
                                System.out.println(" You can roll 3 dice, Type in 1 to roll");
                                ...
                                System.out.println(" You can roll 2 dice, Type in 1");
                                String Z = rolling.nextLine();
                                if (Z.equals("1")) {
                        ...
                        if (NotEnoughTroops == false) {
                            ...
                            while (TypeInCheck2 == true) {
                                if (Defender.getTroopCount() >= 2) {
                                    System.out.println(Defender.getTeam() + " You can roll 2 dice to defend your land," +
                                            " Type in 1 to roll");
                                    ...
                                    System.out.println(Defender.getTeam() + " You can roll 1 dice to defend your land," +
                                            " Type in 1 to roll");
                                    String K = defenderRoll.nextLine();
                                    if (K.equals("1")) {
